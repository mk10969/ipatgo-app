...
public class RaceRefundController {
    private final JvStoredRaceRefundRepository jvRepository;

    public RaceRefundController(JvStoredRaceRefundRepository jvRepository) {
        this.jvRepository = jvRepository;
    }


    @GetMapping("/raceRefund")
    public Flux<RaceRefund> readFluxOnThisWeek() {
        return Mono
    ...
    public Flux<RaceRefund> readFluxOnStandard(@PathVariable(value = "epochSecond") Long epochSecond) {
        return Mono
