package org.uma.platform.bean.neta;

import org.junit.jupiter.api.Test;
import org.uma.platform.bean.response.JvOpenResult;
...
//
    ...
    public void test1() {
        try {
            Class<?> clazz = Class.forName("org.uma.bean.jvlink.response.JvOpenResult");
